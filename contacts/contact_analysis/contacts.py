...
# Get the directory where the .txt files are located
...
for filename in os.listdir(input_dir):
    if filename.endswith(".txt"):
        ...
        # Get the GPCR and Gprotein information from the GPCR_structs_clean.tsv file
        with open('./use_file/GPCR_structs_clean.tsv') as e:
            for line in e:
                l = line.split('\t')
                pdb1 = l[0]
                gpcr_uniprot = l[1]
        ...
        # Find the mapping using the database generated from SIFTS
