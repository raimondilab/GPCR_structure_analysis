...
gs.to_csv('./network/files/gs_contact_cons.tsv',index=None,header=True,sep='\t')
#gio
...
gio.to_csv('./network/files/gio_contact_cons.tsv',index=None,header=True,sep='\t')

#gs
nodes1=gs.iloc[:,[5,16]].drop_duplicates()
nodes2=gs.iloc[:,[6,15]].drop_duplicates()
nodes1.columns = ['struct','num']
nodes2.columns = ['struct','num']
nodes = pd.concat([nodes1, nodes2], axis=0)
nodes.columns = ['struct','num_cont_gs']
nodes.to_csv('./network/files/gs_nodes_cons.tsv',index=None,header=True,sep='\t')
links=gs.iloc[:,[5,6,12,14]].drop_duplicates()
links.columns = ['SS1','SS2','cont_gs',"fraction_gs"]
links.to_csv('./network/files/gs_links_cons.tsv',index=None,header=True,sep='\t')

#gio
nodes4=gio.iloc[:,[5,16]].drop_duplicates()
nodes5=gio.iloc[:,[6,15]].drop_duplicates()
...
nodes3.to_csv('./network/files/gio_nodes_cons.tsv',index=None,header=True,sep='\t')
links2=gio.iloc[:,[5,6,12,14]].drop_duplicates()
links2.columns = ['SS1','SS2','cont_gio',"fraction_gio"]
links2.to_csv('./network/files/gio_links_cons.tsv',index=None,header=True,sep='\t')
...
gq11.to_csv('./network/files/gq11_contact_cons.tsv',index=None,header=True,sep='\t')
...
g1213.to_csv('g1213_contact_cons.tsv',index=None,header=True,sep='\t')
'''
#s=pd.concat([gs,gio,gq11,g1213])
s=pd.concat([gs,gio,gq11])
#s=pd.concat([gs,gio])
s=s[['BW','Gprot_pos', 'gfam','fraction_pair']].drop_duplicates()
s.to_csv('./network/files/fraction_pair_cons.tsv',index=None,header=True,sep='\t')

#gq11
nod1=gq11.iloc[:,[5,16]].drop_duplicates()
nod2=gq11.iloc[:,[6,15]].drop_duplicates()
nod1.columns = ['struct','num']
nod2.columns = ['struct','num']
nod = pd.concat([nod1, nod2], axis=0)
nod.columns = ['struct','num_cont_gq11']
nod.to_csv('./network/files/gq11_nodes_cons.tsv',index=None,header=True,sep='\t')
lin=gq11.iloc[:,[5,6,12,14]].drop_duplicates()
lin.columns = ['SS1','SS2','cont_gq11',"fraction_gq11"]
lin.to_csv('./network/files/gq11_links_cons.tsv',index=None,header=True,sep='\t')
'''
#g1213
nodes4=g1213.iloc[:,[5,16]].drop_duplicates()
nodes5=g1213.iloc[:,[6,15]].drop_duplicates()
nodes4.columns = ['struct','num']
nodes5.columns = ['struct','num']
nodes3 = pd.concat([nodes4, nodes5], axis=0)
nodes3.columns = ['struct','num_cont_g1213']
nodes3.to_csv('g1213_nodes_cons.tsv',index=None,header=True,sep='\t')
links2=g1213.iloc[:,[5,6,12,14]].drop_duplicates()
links2.columns = ['SS1','SS2','cont_g1213',"fraction_g1213"]
links2.to_csv('g1213_links_cons.tsv',index=None,header=True,sep='\t')
'''

####classA
clas=pd.read_csv("./use_file/classification.txt", comment="#", sep="\t")
classA=df.merge(clas,left_on=['GPCR'],right_on=['GPCR'],how="left")
...
gs1.to_csv('./network/files/gs_contact_cons_classA.tsv',index=None,header=True,sep='\t')
#gio1
...
gio1.to_csv('./network/files/gio_contact_cons_classA.tsv',index=None,header=True,sep='\t')
...
node.to_csv('./network/files/gs_nodes_cons_classA.tsv',index=None,header=True,sep='\t')
...
link.to_csv('./network/files/gs_links_cons_classA.tsv',index=None,header=True,sep='\t')
...
node3.to_csv('./network/files/gio_nodes_cons_classA.tsv',index=None,header=True,sep='\t')
...
link2.to_csv('./network/files/gio_links_cons_classA.tsv',index=None,header=True,sep='\t')
...
gq111.to_csv('./network/files/gq11_contact_cons_classA.tsv',index=None,header=True,sep='\t')
...
g12131.to_csv('./network/files/g1213_contact_cons_classA.tsv',index=None,header=True,sep='\t')
'''
...
s1.to_csv('./network/files/fraction_pair__cons_classA.tsv',index=None,header=True,sep='\t')

#gq111
no1=gq111[["Structural","num_cont_gpcr"]].drop_duplicates()
no2=gq11[["Gprot_struct","num_cont_gprot"]].drop_duplicates()
no1.columns = ['struct','num']
no2.columns = ['struct','num']
no = pd.concat([no1, no2], axis=0)
no.columns = ['struct','num_cont_gq11']
no.to_csv('./network/files/gq11_nodes_cons_classA.tsv',index=None,header=True,sep='\t')
...
li.to_csv('./network/files/gq11_links_cons_classA.tsv',index=None,header=True,sep='\t')

'''
#g1213
no4=g12131.iloc[:,[5,19]].drop_duplicates()
no5=g12131.iloc[:,[9,18]].drop_duplicates()
no4.columns = ['struct','num']
no5.columns = ['struct','num']
no3 = pd.concat([node4, node5], axis=0)
no3.columns = ['struct','num_cont_gio']
no3.to_csv('./network/files/g1213_nodes_cons_classA.tsv',index=None,header=True,sep='\t')
li2=g12131.iloc[:,[5,9,15,17]].drop_duplicates()
li2.columns = ['SS1','SS2','cont_gio',"fraction_gio"]
li2.to_csv('./network/files/g1213_links_cons_classA.tsv',index=None,header=True,sep='\t')
'''
