...
d1.to_csv("./statistics/files/venn_gfam_"+fil+".tsv",index=None,header=True,sep='\t')
...
n4=d1.loc['Gio+Gs', 'Receptor_Gene_name']
...
ax=venn3(subsets = (n2,n1,n4,n3,n5,0,n6), set_labels = ('Gio', 'Gs','Gq11'),set_colors=(color_blue,color_red,color_green ))
for t in ax.set_labels: t.set_fontsize(50)
for t in ax.subset_labels: t.set_fontsize(40)
...
p, tx, autotexts =plt.pie(sizes, colors=colors, labels=labels, pctdistance=0.7,
        explode=explode, autopct="",textprops={'fontsize': 45},startangle=90)
...
colors = [color_blue,color_green,color_red,color_purple]
plt.figure(figsize=(30,30))

p, tx, autotexts =plt.pie(sizes, colors=palette_color, labels=labels, pctdistance=0.85,
        autopct="",textprops={'fontsize': 45},startangle=45)
for w in p:
    w.set_linewidth(2)
...
p, tx, autotexts =plt.pie(sizes, colors=palette_color, labels=labels, pctdistance=0.7,
        autopct="",textprops={'fontsize': 55},startangle=45)
for w in p:
    w.set_linewidth(2)
    w.set_edgecolor('black')
fig = plt.gcf()
...
p, tx, autotexts =plt.pie(sizes, colors=palette_color, labels=labels, pctdistance=0.7,
        autopct="",textprops={'fontsize': 55},startangle=90)
for w in p:
    w.set_linewidth(2)
    w.set_edgecolor('black')
fig = plt.gcf()
...
d8.to_csv("./statistics/files/gprotein_gpcr_class_"+fil+".tsv",index=None,header=True,sep='\t')
...
d9.to_csv("./statistics/files/gprotein_pdbid_class_"+fil+".tsv",index=None,header=True,sep='\t')
