...
g1213.to_csv('g1213_contact_all.tsv',index=None,header=True,sep='\t')
'''
...
nodes3.to_csv('g1213_nodes_all.tsv',index=None,header=True,sep='\t')
links2=g1213.iloc[:,[5,6,12,14]].drop_duplicates()
links2.columns = ['SS1','SS2','cont_g1213',"fraction_g1213"]
links2.to_csv('g1213_links_all.tsv',index=None,header=True,sep='\t')
'''
