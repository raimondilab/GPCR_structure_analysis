...
tf=t1.fillna('-')
tf.to_csv('./heatmaps/files/log_odds_gprot_pos.tsv',index=True,header=True,sep='\t')
...
tg=tg1.fillna('-')
tg.to_csv('./heatmaps/files/log_odds_gpcr_pos.tsv',index=True,header=True,sep='\t')
...
g.savefig('./heatmaps/plots/Gs_vs_Gio_receptor_gprot_cluster_all.svg',dpi=600,bbox_inches='tight',format='svg')
...
g1.savefig('./heatmaps/plots/Gs_vs_Gio_receptor_gpcr_cluster_all.svg',dpi=600,bbox_inches='tight',format='svg')
...
plt.savefig('./heatmaps/plots/barplot_count_gprot_all.svg',dpi=600,bbox_inches='tight',format='svg')
...
plt.savefig('./heatmaps/plots/barplot_count1_gpcr_all.svg',dpi=600,bbox_inches='tight',format='svg')
