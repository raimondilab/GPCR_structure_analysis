...
df3['CHAIN'][(df3['#PDBID']=='5g53')&(df3['CHAIN']=='B')] ='A'
df3['CHAIN'][(df3['#PDBID']=='5g53')&(df3['CHAIN']=='D')] ='C'
...
df6=df5.loc[df5['BW'].isin(['1.49','1.5','1.51','2.49','2.5','2.51','3.49','3.5','3.51','4.49','4.5','4.51','5.49','5.5','5.51','6.49','6.5','7.49','7.5','7.51'])]
#gprot all
