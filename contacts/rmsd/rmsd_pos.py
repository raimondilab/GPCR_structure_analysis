...
import pandas as pd
import numpy as np
df=pd.read_csv("GPCR_structs_clean.tsv", comment="#", sep="\t")
...
df6=df5.loc[df5['BW'].isin(['1.49','1.5','1.51','3.49','3.5','3.51','4.49','4.5','4.51','5.41','6.49','6.5'])]
#gprot all
...
ds6.to_csv('gpcr_pos_all_12.tsv',index=None,header=True,sep='\t')
ds7.to_csv('gprot_pos_all.tsv',index=None,header=True,sep='\t')
ds8.to_csv('gpcr_pos_all.tsv',index=None,header=True,sep='\t')
