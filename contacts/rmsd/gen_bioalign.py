...
for l in open("gpcr_pos_all.tsv", "rt"):
  pdb=l.split(fs)[0]
  chain=l.split(fs)[1]
...
with open("./rmsd_sh/bioalign_gprot_cons_gpcr_all.sh", "a") as f:
...
Gprot_r={}
Gpcr_r={}
for l in open("gprot_pos_all.tsv", "rt"):
  pdb=l.split(fs)[0]
  chain=l.split(fs)[1]
  res=l.split(fs)[2].strip("\n").strip(",")
  #print (pdb, len(res.split(",")))
...
#print (list(Gpcr_r.keys()))
with open("./rmsd_sh/bioalign_gprot_all_gpcr_all.sh", "a") as f1:
...
for l in open("gpcr_pos_all_12.tsv", "rt"):
  pdb=l.split(fs)[0]
  chain=l.split(fs)[1]
  res=l.split(fs)[2].strip("\n").strip(",")
  #print (pdb, len(res.split(",")))
...
#print (list(Gpcr_r.keys()))
with open("./rmsd_sh/bioalign_gprot_cons_gpcr_all12.sh", "a") as f2:
...
#print (list(Gpcr_r.keys()))
with open("./rmsd_sh/bioalign_gprot_all_gpcr_all12.sh", "a") as f3:
...
split0 = Split('./rmsd_sh/bioalign_gprot_cons_gpcr_all12.sh','./rmsd_sh/')
split1 = Split('./rmsd_sh/bioalign_gprot_cons_gpcr_all.sh','./rmsd_sh/')
split2 = Split('./rmsd_sh/bioalign_gprot_all_gpcr_all.sh','./rmsd_sh/')
split3 = Split('./rmsd_sh/bioalign_gprot_all_gpcr_all12.sh','./rmsd_sh/')

split0.bylinecount(linecount=2921, includeheader = True)
split1.bylinecount(linecount=2921, includeheader = True) 
split2.bylinecount(linecount=2921, includeheader = True) 
split3.bylinecount(linecount=2921, includeheader = True)  
